...
public class MovTregaloDto {
    ...
    public String toString() {
        return "MovTregaloDto{" + "atmseq=" + getAtmseq() + ", idturno=" + getIdturno() + ", tclave=" + getTclave() + ", num_ticket=" + getNum_ticket() + ", iclave=" + getIclave() + ", icb=" + getIcb() + ", caja=" + getCaja() + ", pclave=" + getPclave() + ", fechax=" + getFechax() + ", atmdesc=" + getAtmdesc() + ", atmcant=" + getAtmcant() + ", atmcosto=" + getAtmcosto() + ", atmventa=" + getAtmventa() + ", userid=" + getUserid() + ", iv_clave=" + getIv_clave() + ", ie_clave=" + getIe_clave() + ", gclave=" + getGclave() + ", lclave=" + getLclave() + ", fechay=" + getFechay() + ", porcentaje=" + getPorcentaje() + '}';
    }
