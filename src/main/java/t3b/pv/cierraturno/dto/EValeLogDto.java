...
public class EValeLogDto {
    ...
    public String toString() {
        return "EValeLogDto{" + "log_id=" + log_id + ", log_server_id=" + log_server_id + ", user_id=" + user_id + ", tarjeta_id=" + tarjeta_id + ", tarjeta_num=" + tarjeta_num + ", tienda=" + tienda + ", caja=" + caja + ", num_ticket=" + num_ticket + ", fech=" + fech + ", monto=" + monto + ", atmdesc=" + atmdesc + ", nc_envio=" + nc_envio + ", nc_recibo=" + nc_recibo + ", ip_local=" + ip_local + ", ip_trans=" + ip_trans + ", st_sldo=" + st_sldo + ", st_nce=" + st_nce + ", st_ncr=" + st_ncr + ", st_server=" + st_server + ", idturno=" + idturno + '}';
    }
